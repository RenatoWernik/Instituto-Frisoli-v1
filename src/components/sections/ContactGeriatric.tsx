...
import { Mail, MapPin, Phone, Clock, Accessibility } from "lucide-react";
...
const contactInfo = [
    ...
    },
    {
        icon: MapPin,
        label: "Visite-nos",
        value: "Rua Gomes de Carvalho, 1356 - Vila Olímpia, SP",
        href: "https://maps.google.com/?q=Rua+Gomes+de+Carvalho+1356+Vila+Olimpia+Sao+Paulo",
    },
    {
        icon: Mail,
        label: "Email",
...
export function ContactGeriatric() {
