        ...
        >
            ...
            <div className="absolute inset-0 z-0">
                <img
                    ...
                    className="w-full h-full object-cover object-[30%_center] md:object-center blur-[2.5px]"
                />
                {/* Gradient Overlay for Text Readability */}
                <div className="absolute inset-0 bg-gradient-to-t from-white/40 via-white/10 to-transparent md:bg-gradient-to-t md:from-white/40 md:via-white/10 md:to-transparent z-10" />
            </div>
                ...
                <div className="max-w-2xl">
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-7xl font-serif font-medium text-white leading-[1.15]">
                                Acolhimento que <br />
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 pt-4 items-center pl-1">
                            ...
                            <Link href="/contato" className="group relative flex items-center gap-3 border border-white rounded-full px-8 py-3 transition-colors duration-300 hover:border-primary">
                                ...
                                <ArrowRight className="w-5 h-5 text-white transition-all duration-300 group-hover:translate-x-1 group-hover:text-primary" />
                            </Link>
